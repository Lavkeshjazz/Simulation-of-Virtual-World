class Building{
    constructor(poly, heightCoef=200){
        this.base=poly;
    ...
    draw(ctx,viewPoint){
        //Applying 3d effect in buildings
         const topPoints=this.base.points.map((p)=>
            getFake3dPoint(p, viewPoint, this.heightCoef * 0.6)
    );
        ...
        const baseMidpoints = [
         ...
         const topMidpoints = baseMidpoints.map((p) =>
            ...
            getFake3dPoint(p, viewPoint, this.heightCoef)
